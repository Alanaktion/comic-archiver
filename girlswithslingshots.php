...
$html = file_get_contents('https://www.girlswithslingshots.com/comic/gws-chaser-1000');
...
while (true) {
    ...
    $url = "https://www.girlswithslingshots.com/comics/{$matches[1]}";
    ...
    $regex = '@rel="prev" href="(https://www.girlswithslingshots.com/comic/[0-9a-zA-Z-]+)"@';
